(function(){
  ...
  // loads a new template from templates/name.html file, caches it in cachedTemplates and invokes a callback
  ...
  // renders a collection of hashes, rendering each hash with the "render" function and applying the result
